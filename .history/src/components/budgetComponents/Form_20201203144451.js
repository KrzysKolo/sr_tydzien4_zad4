...
const FormData = () => {
    ...
    const validationSchema = yup.object({
        ...
        category: yup.number().required("Required").min(0, ).max(5),
    })
    ...
    return (
        <FormWrapper onSubmit={formik.handleSubmit}>
            ...
            <Input type="text" label="Kwota transakcji" name="amount" placeholder="kwota..." onChange={formik.handleChange} value={formik.values.amount+`zł`} onBlur={formik.handleBlur} error={formik.errors.amount} message={formik.errors.amount} touched={formik.touched.amount}/>
