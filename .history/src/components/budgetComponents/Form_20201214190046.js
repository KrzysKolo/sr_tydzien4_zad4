...
const FormData = ({ showForm, setShowForm }) => {
    ...
    return (
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
            ...
            <Input type="text" label="Transaction amount" name="amount" placeholder="kwota..." onChange={formik.handleChange} value={formik.values.amount} onBlur={formik.handleBlur} error={formik.errors.amount} message={formik.errors.amount} touched={formik.touched.amount}/>
