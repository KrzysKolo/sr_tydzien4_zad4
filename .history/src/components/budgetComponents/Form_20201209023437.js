...
const FormData = ({ showForm, setShowForm }) => {
    ...
    return (
        ...
        <FormWrapper onSubmit={formik.handleSubmit}>
            ...
            <Input type="text" label="Nazwa transakcji" name="name" placeholder="nazwa transakcji..." onChange={formik.handleChange} onChange={onChange} value={formik.values.name} onBlur={formik.handleBlur} error={formik.errors.name} message={formik.errors.name} touched={formik.touched.name} />
