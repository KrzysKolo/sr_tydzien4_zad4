...
const Form = () => {
    ...
    return (
        <FormWrapper onSubmit={formik.handleSubmit}>
            ...
            <Input type="text" label="Nazwa transakcji" name="name" values={formik.values.name} onChange={formik.handleChange} placeholder="nazwa transakcji..." error={"aaaa"} message={validationSchema.name} />
