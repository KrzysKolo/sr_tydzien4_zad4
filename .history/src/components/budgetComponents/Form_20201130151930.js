...
const Form = () => {
    ...
    return (
        <FormWrapper onSubmit={formik.handleSubmit}>
            ...
            <Input type="text" label="Nazwa transakcji" values={formik.values.name} placeholder="nazwa transakcji..." error={"aaaa"} message={"medss"} />
            <Input type="text" label="Kwota transakcji" values={formik.values.amount} " placeholder="kwota..." error={"aaaa"} message={"medss"} />
            <Select options={SelectOptions} label="Wybierz kategorię transakcji" values={formik.values.category}  />
            <ButtonWrapper>
