...
const SectionInfo = ({ title, total }) => {
    const { deleteTransactionsIncome, deleteTransactionsExpense } = useContext(GlobalContext);
    ...
    return (
        ...
        <SectionWrapper>
           ...
           <ButtonWrapper>
                ...
                <Button title="Usuń wszystko" icons={faTrashAlt} type="submit" onClick={() => deleteTransactionsIncome()}/>
           </ButtonWrapper>
