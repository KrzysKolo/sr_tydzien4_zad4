...
const Form = () => {
    ...
    return (
        <FormWrapper onSubmit={formik.handleSubmit}>
            ...
            <Input type="text" label="Nazwa transakcji" values={formik.values.name} placeholder="nazwa transakcji..." error={"aaaa"} message={"input1"} />
            <Input type="text" label="Kwota transakcji" values={formik.values.amount} placeholder="kwota..." error={"aaaa"} message={"input2"} />
            <Select options={SelectOptions} label="Wybierz kategorię transakcji" values={formik.values.category} message={"select"} />
            <ButtonWrapper>
