...
const Form = () => {
    ...
    return (
        <FormWrapper onSubmit={formik.handleSubmit}>
            ...
            <Input type="text" label="Kwota transakcji" name="amount" values={formik.values.amount} placeholder="kwota..." />
            <Select options={SelectOptions} label="Wybierz kategorię transakcji" name="category" values={formik.values.category} error={"aaaa"} message={"select"} />
            <ButtonWrapper>
