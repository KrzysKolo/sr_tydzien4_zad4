...
const Form = () => {
    ...
    return (
        ...
        <FormWrapper>
            ...
            <Input type="text" label="Nazwa transakcji" name="name" values={initialValues.name} onChange={formik.handleChange} placeholder="nazwa transakcji..." error={"aaaa"} message={this.validationSchema.name} />
            <Input type="text" label="Kwota transakcji" name="amount" values={initialValues.amount} onChange={formik.handleChange}  placeholder="kwota..." />
            <Select options={SelectOptions} label="Wybierz kategorię transakcji" name="category" values={initialValues.category} onChange={formik.handleChange}  error={"aaaa"} message={"select"} />
            <ButtonWrapper>
