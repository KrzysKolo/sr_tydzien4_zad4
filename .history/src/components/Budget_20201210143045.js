...
const Budget = () => {
    ...
    const totalAmounte = totalIncome - totalExpense;
    const {deleteTransaction} = useContext(GlobalContext);
    console.log(incomeTransactions.id);
    return (
            ...
            <Container>
                ...
                <SectionContainer>
                    <SectionBudget>
                        ...
                        <DivItems>
                            <Section title="Income" label="income" data={incomeTransactions} total={+totalIncome} onClick={() => deleteTransaction(incomeTransactions.id)}/>
                            <Section title="Expenses" data={expenseTransactions} total={-totalExpense} onClick={() => deleteTransaction(expenseTransactions.id)}/>
                        </DivItems>
                    </SectionBudget>
